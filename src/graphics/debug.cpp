...
static std::string stringify_message_severity(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity) {
	...
	case VK_DEBUG_UTILS_MESSAGE_SEVERITY_INFO_BIT_EXT		   : severity = "[inf]"; break;
	...
	case VK_DEBUG_UTILS_MESSAGE_SEVERITY_FLAG_BITS_MAX_ENUM_EXT: severity = "[fatal]"; break;
	default													   : severity = "[unk]";
	}
	return severity;
}
...
VkBool32 graphics::debug::debug_callback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageType,
	...
	if (messageSeverity == VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT || messageSeverity == VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT ||
		...
		std::cerr << oss.str();
	else if (messageType == VK_DEBUG_UTILS_MESSAGE_TYPE_GENERAL_BIT_EXT || messageType == VK_DEBUG_UTILS_MESSAGE_TYPE_DEVICE_ADDRESS_BINDING_BIT_EXT)
		std::cout << oss.str();
	else
		std::clog << oss.str();
...
VkResult graphics::debug::create_debug_utils_messenger_ext(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT *pCreateInfo,
...
void graphics::debug::destroy_debug_utils_messenger_ext(VkInstance instance, VkDebugUtilsMessengerEXT debugMessenger, const VkAllocationCallbacks *pAllocator) {
